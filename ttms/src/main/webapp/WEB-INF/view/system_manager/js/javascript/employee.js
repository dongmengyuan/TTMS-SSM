...
function model() {
    ...
    document.getElementById('tele').value = array.info[2];
    document.getElementById('addr').value = array.info[3];
    document.getElementById('email').value = array.info[4];
...
function save(obj) {
    ...
    info[2]=document.getElementById('tele').value;
    info[3]=document.getElementById('addr').value;
